...
public class CreateAcampaignWithStatus {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 Thread.sleep(2000);
		 driver.findElement(By.name("campaignName")).sendKeys("Vithu");
		 Thread.sleep(2000);
		 WebElement target = driver.findElement(By.name("targetSize"));
		 target.clear();
		 target.sendKeys("10");
		 Thread.sleep(2000);
		 driver.findElement(By.name("campaignStatus")).sendKeys("passed");
